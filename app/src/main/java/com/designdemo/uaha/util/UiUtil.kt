...
object UiUtil {
     ...
     *
     * @param dp A value in dp (density independent pixels) unit. Needed to convert to pixels
    ...
    /**
     * This will apply special formatting to the input strings.  The first word will be bolded and
     * second will be italicized
     *
    ...
    fun getRandomColor(): Int {
        val colors = intArrayOf(R.color.red_500, R.color.pink_500, R.color.purple_500,
                R.color.deep_purple_500, R.color.indigo_500, R.color.blue_500,
                R.color.light_blue_500, R.color.cyan_500, R.color.teal_500, R.color.green_500,
                R.color.light_green_500, R.color.lime_500, R.color.yellow_500, R.color.amber_500,
                R.color.orange_500, R.color.deep_orange_500, R.color.brown_500,
                R.color.blue_grey_500, R.color.grey_500)
        val randInt = Random().nextInt(colors.size)
        return colors[randInt]
    }

    fun getRandomDrawable(): Int {
        val drawables = intArrayOf(R.drawable.vct_location_pin, R.drawable.vct_business,
                R.drawable.vct_train, R.drawable.vct_cost)
